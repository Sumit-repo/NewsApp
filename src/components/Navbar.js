...
export default function Navbar(props) {
  return (
    <div>
      <nav className={`navbar fixed-top navbar-expand-lg ${props.background}`}>
              ...
              <li className="nav-item dropdown mx-2">
                ...
                <ul className="dropdown-menu">
                  ...
                  <li>
                    <Link
                      className="dropdown-item"
                      to="/newsapp/category/entertainment"
                    >
                      Entertainment
                    </Link>
                  </li>
                  ...
                  <li>
                    <Link
                      className="dropdown-item"
                      to="/newsapp/category/technology"
                    >
                      Technology
                    </Link>
                  </li>
